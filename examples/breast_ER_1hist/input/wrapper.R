...
user_options_file = 'user_options_ERonly.R'
input_data_file = 'input_temp_ERonly.csv'
...
model_version = 'breast_ER_1hist'
model_description = c(#data='ademuyiwa_real_2', 
                      data='mostly JNCI monograph',
                      sampling='N/A',
                      model_method='20% stage shift',
                      design='three trials: historical, 1999, perfect',
                      stage='early and advanced',
                      prognostic_factors='ER',
                      treatments='None, Tamoxifen, Chemo, Tamoxifen+Chemo, Chemo+Trastuzumab, Tamoxifen+Trastuzumab',
                      efficacies='from EBTCG, Cochrane-Trazt=0.66 for early, 0.82 for advanced',
                      life_table='BMD-study_year=1975 not 2000',
