...
user_options_file = 'user_optionsSensitivityExpInstage.R'
...
model_version = 'breast_ER-HER2_6SensitivityExpInstage'
model_description = c(#data='ademuyiwa_real_2', 
  data='mostly JNCI monograph',
  sampling='N/A',
  model_method='15% abd 50% stage shift, instage benefits of .7, for advanced and early stages (independent), Weibull mortality distribution',
